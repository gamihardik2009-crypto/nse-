...
while True:
    ...
    if "BEARISH" in result:
        result_col = Fore.RED + result + Style.RESET_ALL
    elif "BULLISH" in result:
        result_col = Fore.GREEN + result + Style.RESET_ALL
    else:
        result_col = result

    # -------- OI COLOR --------
    R1c = Fore.YELLOW + str(R1) + Style.RESET_ALL
    R2c = Fore.YELLOW + str(R2) + Style.RESET_ALL
    R3c = Fore.YELLOW + str(R3) + Style.RESET_ALL
    S1c = Fore.YELLOW + str(S1) + Style.RESET_ALL
    S2c = Fore.YELLOW + str(S2) + Style.RESET_ALL
    S3c = Fore.YELLOW + str(S3) + Style.RESET_ALL
